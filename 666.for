...
C
        PROGRAM PEHL2
        PARAMETER(M=3,NA=256,NB=256,KD=1,PI=3.1415926,NT1=100,
     &            NT2=100)
...
C       无量纲时间间隔
	  ...
	  OMIG1=0.3
        OMIG2=0.03
	  ELSEIF(NT.GT.50.AND.NT.LE.80)THEN
	  OMIG1=0.1
	  OMIG2=0.03
	  ELSEIF(NT.GT.80.AND.NT.LE.84)THEN
	  OMIG1=0.2
	  OMIG2=0.02
	  ELSE
	  OMIG1=0.2
...
C再对每一行作IFFT
  ...
  500   CONTINUE
	  DO 700 I=0,NXS
        DO 600 J=0,NYS
        HS(I,J)=H00+0.5*(XS(I)**2+YS(J)**2)+AL1*HS(I,J)
  600   CONTINUE
  700   CONTINUE
        END
C
